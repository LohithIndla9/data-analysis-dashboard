...
1. **Upload:** Drop in any `.csv` file via the sidebar/uploader (or test with the provided `sample_data.csv`).
...
git clone https://github.com/LohithIndla9/data-analysis-dashboard.git
...
├── sample_data.csv     # Ready-to-use sample dataset for testing all features
